		...
		<div class="grid gap-8 lg:grid-cols-[1fr,400px]">
			...
			<div class="flex flex-col items-center justify-center">
				<div class="relative">
					<!-- Pointer -->
					<div
						class="absolute left-1/2 top-0 z-10 h-0 w-0 -translate-x-1/2 border-x-[15px] border-t-[30px] border-x-transparent border-t-red-500"
					></div>
			...
			<div class="flex flex-col">
				<h2 class="mb-4 text-xl font-semibold">Names ({names.length})</h2>
